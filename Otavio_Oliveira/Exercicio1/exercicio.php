...
function exercicio18L($areaMetros) {
    $QtdLitrosTotal = ceil(($areaMetros/3)*1.1); //função ceil() arredonda o número para inteiro
    $QtdLatas18L = ceil($QtdLitrosTotal/18);     //função ceil() arredonda o número para inteiro
